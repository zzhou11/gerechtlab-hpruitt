function [outputData] = getMSD(data,trackNumber, time_interval)
%   GETMSD Returns a matrix of time (col 1) vs. MSD (col 2) of a track in a dataset. 
...
for i = 2:(size(track, 1))
    ...
    outputData = [outputData; (i - 1) * time_interval, MSD];
end
