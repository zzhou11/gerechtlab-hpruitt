function [outputData] = getArrestCoeff(data,time_interval, threshold)
...
for i=1:maxTrackIndex;  %run through every track 
    velocities = getVelocities(data,i,time_interval); %get a matrix with the velocities of the current track
